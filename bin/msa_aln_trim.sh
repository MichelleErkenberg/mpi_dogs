...
cat "$msa_dir/combined_trim.fasta" \
    /mnt/expressions/michelle_erkenberg/github/mpi_dogs/data/science_dogs/Canis_latrans.fasta \
    /mnt/expressions/michelle_erkenberg/github/mpi_dogs/data/science_dogs/science_dogs_all.fasta \
    > "$msa_dir/combined_trim_with_pub.fasta"
