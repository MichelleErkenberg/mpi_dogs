...
#old version
python3 env_bam/bam_filder(old).py "$BASE_PATH/data/dog_samples/ref/office_1/5dogs.Heidi.csv" "$BASE_PATH/data/env_samples/Canidae/sample_10.Canidae.Canis_lupus_familiaris_deduped_bedfiltered.bam" "$BASE_PATH/data/env_bam" "Heidi"
